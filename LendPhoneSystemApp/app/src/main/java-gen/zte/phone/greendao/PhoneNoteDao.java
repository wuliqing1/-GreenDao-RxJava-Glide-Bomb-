...
public class PhoneNoteDao extends AbstractDao<PhoneNote, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Phone_photo = new Property(5, String.class, "phone_photo", false, "PHONE_PHOTO");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PhoneNoteTable\" (" + //
                ...
                "\"PHONE_PHOTO\" TEXT);"); // 5: phone_photo
    }
    ...
    protected void bindValues(SQLiteStatement stmt, PhoneNote entity) {
        ...
        String phone_photo = entity.getPhone_photo();
        if (phone_photo != null) {
            stmt.bindString(6, phone_photo);
        }
    }
    ...
    public PhoneNote readEntity(Cursor cursor, int offset) {
        PhoneNote entity = new PhoneNote( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5) // phone_photo
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PhoneNote entity, int offset) {
        ...
        entity.setPhone_photo(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
     }
