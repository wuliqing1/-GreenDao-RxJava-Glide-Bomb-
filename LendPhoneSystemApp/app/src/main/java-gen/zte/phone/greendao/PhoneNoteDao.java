...
public class PhoneNoteDao extends AbstractDao<PhoneNote, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Phone_time = new Property(4, java.util.Date.class, "phone_time", false, "PHONE_TIME");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PhoneNoteTable\" (" + //
                ...
                "\"PHONE_TIME\" INTEGER," + // 4: phone_time
    ...
    protected void bindValues(SQLiteStatement stmt, PhoneNote entity) {
        ...
        java.util.Date phone_time = entity.getPhone_time();
        if (phone_time != null) {
            stmt.bindLong(5, phone_time.getTime());
        }
    ...
    public PhoneNote readEntity(Cursor cursor, int offset) {
        PhoneNote entity = new PhoneNote( //
            ...
            cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)), // phone_time
    ...
    public void readEntity(Cursor cursor, PhoneNote entity, int offset) {
        ...
        entity.setPhone_time(cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)));
