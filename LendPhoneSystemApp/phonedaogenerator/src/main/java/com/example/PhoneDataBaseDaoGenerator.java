...
public class PhoneDataBaseDaoGenerator {
    public static void main(String[] args) throws Exception {
        // 正如你所见的，你创建了一个用于添加实体（Entity）的模式（Schema）对象。
        // 两个参数分别代表：数据库版本号与自动生成代码的包路径。
        Schema schema = new Schema(1, "zte.phone.greendao");
...
//      schema.setDefaultJavaPackageDao("me.itangqi.dao");
        ...
        new DaoGenerator().generateAll(schema, "D:\\os_china_git\\LendPhoneSystem\\LendPhoneSystemApp\\app\\src\\main\\java-gen");
    }
    ...
    private static void addNote(Schema schema) {
        ...
        Entity note = schema.addEntity("PhoneNote");
        // 你也可以重新给表命名
        note.setTableName("PhoneNoteTable");
        ...
        note.addStringProperty("phone_photo");
