...
//            Toast.makeText(view.getContext(), mDataList.get(position).desc, Toast.LENGTH_SHORT).show();
            String url = mDataList.get(position).url;
            Intent intent = new Intent(DisplayImageActivity.ACTIVITY_ACTION);
            intent.putExtra(DisplayImageActivity.URL_KEY, url);
